...
.LBB22_7:                               ;   Parent Loop BB22_3 Depth=1
	...
	sbc	hl, bc
	jr	nz, .LBB22_4
; %bb.8:                                ;   in Loop: Header=BB22_7 Depth=3
	ld	hl, (ix - 5)
	push	hl
	call	_viewer_run
	pop	hl
...
; %bb.0:
	...
	.local	.Lfunc_end42
.Lfunc_end42:
	.size	_sync_draw, .Lfunc_end42-_sync_draw
                                        ; -- End function
...
; %bb.13:                               ; %input_pressed.exit
	ld	e, c
	.local	.LBB43_14
.LBB43_14:                              ; %input_pressed.exit
	bit	6, l
	jr	z, .LBB43_16
; %bb.15:                               ; %input_pressed.exit
	ld	a, c
	.local	.LBB43_16
.LBB43_16:                              ; %input_pressed.exit
	or	a, e
	ld	l, a
	pop	hl
	pop	ix
	...
	.local	.Lfunc_end43
.Lfunc_end43:
	.size	_sync_progress, .Lfunc_end43-_sync_progress
                                        ; -- End function
...
; %bb.7:
	...
	.local	.Lfunc_end44
.Lfunc_end44:
	.size	_sync_line, .Lfunc_end44-_sync_line
                                        ; -- End function
...
; %bb.0:
	...
	.local	.Lfunc_end45
.Lfunc_end45:
	.size	_proto_requests, .Lfunc_end45-_proto_requests
                                        ; -- End function
...
; %bb.0:
	...
	.local	.Lfunc_end46
.Lfunc_end46:
	.size	_proto_last_command, .Lfunc_end46-_proto_last_command
                                        ; -- End function
...
; %bb.0:
	...
	.local	.Lfunc_end47
.Lfunc_end47:
	.size	_proto_errors, .Lfunc_end47-_proto_errors
                                        ; -- End function
...
; %bb.0:
	ld	a, (_schedule_error)
	ret
	.local	.Lfunc_end48
.Lfunc_end48:
	.size	_proto_schedule_error, .Lfunc_end48-_proto_schedule_error
                                        ; -- End function
...
; %bb.0:
	...
	.local	.Lfunc_end49
.Lfunc_end49:
	.size	_proto_loops, .Lfunc_end49-_proto_loops
                                        ; -- End function
...
; %bb.4:                                ;   in Loop: Header=BB50_3 Depth=1
	ld	de, 24
	.local	.LBB50_5
.LBB50_5:                               ;   Parent Loop BB50_3 Depth=1
                                        ; =>  This Inner Loop Header: Depth=2
	push	bc
	pop	hl
	or	a, a
...
.LBB50_7:                               ;   in Loop: Header=BB50_3 Depth=1
	...
	.local	.Lfunc_end50
.Lfunc_end50:
	.size	_proto_mark, .Lfunc_end50-_proto_mark
                                        ; -- End function
...
.LBB51_10:                              ;   in Loop: Header=BB51_2 Depth=1
	...
	sbc	hl, hl
	push	hl
	ld	hl, _request_arrived
	push	hl
	ld	hl, 64
	push	hl
	ld	hl, _request_header
	push	hl
	push	de
...
; %bb.25:                               ;   in Loop: Header=BB51_2 Depth=1
	...
	ld	b, h
	.local	.LBB51_26
.LBB51_26:                              ;   Parent Loop BB51_2 Depth=1
                                        ; =>  This Inner Loop Header: Depth=2
	ld	l, e
	ld	h, d
	or	a, a
...
.LBB51_29:                              ;   in Loop: Header=BB51_26 Depth=2
	...
	ld	hl, (ix - 31)
	.local	.LBB51_30
.LBB51_30:                              ;   in Loop: Header=BB51_26 Depth=2
	ld	(ix - 37), de
	pea	ix - 17
	push	bc
	call	_lib_get_strip
...
; %bb.36:                               ;   in Loop: Header=BB51_2 Depth=1
	ld.sis	hl, 0
                                        ; kill: def $hl killed $hl def $uhl
	.local	.LBB51_37
.LBB51_37:                              ;   in Loop: Header=BB51_2 Depth=1
	ld	de, 0
	push	de
	inc	de
	push	de
	...
	bit	0, a
	jp	z, .LBB51_18
; %bb.38:                               ;   in Loop: Header=BB51_2 Depth=1
	ld	hl, 1
	push	hl
	pea	ix - 17
	jp	.LBB51_56
...
.LBB51_41:                              ;   in Loop: Header=BB51_2 Depth=1
	...
	jp	.LBB51_15
	.local	.LBB51_42
.LBB51_42:                              ;   in Loop: Header=BB51_2 Depth=1
	push	de
	ld	(ix - 37), de
	call	_ti_GetSize
	ld	(ix - 31), l
	...
	pop	hl
	.local	.LBB51_43
.LBB51_43:                              ;   Parent Loop BB51_2 Depth=1
                                        ; =>  This Inner Loop Header: Depth=2
	bit	0, a
	jp	z, .LBB51_18
; %bb.44:                               ; %.preheader10
...
; %bb.45:                               ;   in Loop: Header=BB51_43 Depth=2
	...
	ld	(ix - 30), b
	jr	c, .LBB51_47
; %bb.46:                               ;   in Loop: Header=BB51_43 Depth=2
	ld.sis	bc, 512
	.local	.LBB51_47
.LBB51_47:                              ;   in Loop: Header=BB51_43 Depth=2
	ld	(ix - 37), c
	ld	(ix - 36), b
	or	a, a
	sbc	hl, hl
	...
	jr	.LBB51_43
	.local	.LBB51_48
.LBB51_48:                              ;   in Loop: Header=BB51_2 Depth=1
	ld	hl, (ix - 43)
	push	hl
	ld	hl, (ix - 37)
	push	hl
	...
	or	a, a
	jr	nz, .LBB51_57
; %bb.49:                               ;   in Loop: Header=BB51_2 Depth=1
	ld	hl, (ix - 46)
	push	hl
	ld	hl, (ix - 31)
	push	hl
...
.LBB51_52:                              ;   in Loop: Header=BB51_2 Depth=1
	...
	or	a, a
	jp	nz, .LBB51_67
; %bb.53:                               ;   in Loop: Header=BB51_2 Depth=1
	ld	hl, (ix - 46)
	push	hl
	ld	hl, (ix - 31)
	push	hl
	...
	jp	.LBB51_91
	.local	.LBB51_54
.LBB51_54:                              ;   in Loop: Header=BB51_2 Depth=1
	lea	de, iy + 0
	sbc	hl, hl
	adc	hl, de
	jp	z, .LBB51_19
; %bb.55:                               ;   in Loop: Header=BB51_2 Depth=1
	push	de
	ld	hl, _stream
	push	hl
	.local	.LBB51_56
.LBB51_56:                              ;   in Loop: Header=BB51_2 Depth=1
	call	_write_exact
	jp	.LBB51_17
	.local	.LBB51_57
...
.LBB51_58:                              ; %.preheader
	...
	call	__lcmpzero
	jp	z, .LBB51_77
; %bb.59:                               ;   in Loop: Header=BB51_58 Depth=2
	lea	hl, iy + 0
	ld	(ix - 46), de
	...
	lea	de, iy + 0
	jr	nz, .LBB51_61
; %bb.60:                               ;   in Loop: Header=BB51_58 Depth=2
	ld	hl, 512
	ex	de, hl
	.local	.LBB51_61
.LBB51_61:                              ;   in Loop: Header=BB51_58 Depth=2
	ld	(ix - 31), iy
	bit	0, a
	ld	hl, (ix - 46)
	ld	a, l
	jr	nz, .LBB51_63
; %bb.62:                               ;   in Loop: Header=BB51_58 Depth=2
	xor	a, a
	.local	.LBB51_63
.LBB51_63:                              ;   in Loop: Header=BB51_58 Depth=2
	ld	(ix - 53), a
	push	de
	ld	(ix - 52), de
	call	_read_exact
	...
	bit	0, a
	jp	z, .LBB51_92
; %bb.64:                               ;   in Loop: Header=BB51_58 Depth=2
	ld	hl, (ix - 49)
	push	hl
	ld	hl, 1
	push	hl
	...
	ld	a, -1
	jr	z, .LBB51_66
; %bb.65:                               ;   in Loop: Header=BB51_58 Depth=2
	ld	a, 0
	.local	.LBB51_66
.LBB51_66:                              ;   in Loop: Header=BB51_58 Depth=2
	ld	l, (ix - 40)
	and	a, l
	ld	l, a
	ld	(ix - 40), l
	...
	jp	.LBB51_58
	.local	.LBB51_67
.LBB51_67:                              ;   in Loop: Header=BB51_2 Depth=1
	ld	a, 1
	ld	(ix - 40), a                    ; 1-byte Folded Spill
	ld	iy, (ix - 31)
	ld	de, (ix - 46)
	ld	(ix - 37), bc
	.local	.LBB51_68
.LBB51_68:                              ; %.preheader13
                                        ;   Parent Loop BB51_2 Depth=1
                                        ; =>  This Inner Loop Header: Depth=2
	lea	hl, iy + 0
	call	__lcmpzero
	jp	z, .LBB51_86
; %bb.69:                               ;   in Loop: Header=BB51_68 Depth=2
	lea	hl, iy + 0
	ld	(ix - 46), de
                                        ; kill: def $e killed $e killed $ude
	ld	bc, 512
	...
	lea	de, iy + 0
	jr	nz, .LBB51_71
; %bb.70:                               ;   in Loop: Header=BB51_68 Depth=2
	ld	hl, 512
	ex	de, hl
	.local	.LBB51_71
.LBB51_71:                              ;   in Loop: Header=BB51_68 Depth=2
	ld	(ix - 31), iy
	bit	0, a
	ld	hl, (ix - 46)
	ld	a, l
	jr	nz, .LBB51_73
; %bb.72:                               ;   in Loop: Header=BB51_68 Depth=2
	xor	a, a
	.local	.LBB51_73
.LBB51_73:                              ;   in Loop: Header=BB51_68 Depth=2
	ld	(ix - 49), a
	push	de
	ld	(ix - 43), de
	call	_read_exact
	...
	bit	0, a
	jp	z, .LBB51_93
; %bb.74:                               ;   in Loop: Header=BB51_68 Depth=2
	ld	hl, (ix - 37)
	push	hl
	ld	hl, 1
	push	hl
	...
	ld	a, -1
	jr	z, .LBB51_76
; %bb.75:                               ;   in Loop: Header=BB51_68 Depth=2
	ld	a, 0
	.local	.LBB51_76
.LBB51_76:                              ;   in Loop: Header=BB51_68 Depth=2
	ld	l, (ix - 40)
	and	a, l
	ld	l, a
	ld	(ix - 40), l
	...
	jp	.LBB51_68
	.local	.LBB51_77
.LBB51_77:                              ;   in Loop: Header=BB51_2 Depth=1
	bit	0, (ix - 40)                    ; 1-byte Folded Reload
	ld	a, 0
	jr	z, .LBB51_81
; %bb.78:                               ;   in Loop: Header=BB51_2 Depth=1
	push	bc
	ld	hl, 1
	push	hl
	call	_ti_SetArchiveStatus
	...
	ld	a, -1
	jr	nz, .LBB51_80
; %bb.79:                               ;   in Loop: Header=BB51_2 Depth=1
	ld	a, 0
	.local	.LBB51_80
.LBB51_80:                              ;   in Loop: Header=BB51_2 Depth=1
	ld	bc, (ix - 49)
	.local	.LBB51_81
.LBB51_81:                              ;   in Loop: Header=BB51_2 Depth=1
	ld	(ix - 31), a
	push	bc
	call	_ti_Close
	pop	hl
	...
	sbc	hl, bc
	jr	z, .LBB51_83
; %bb.82:                               ;   in Loop: Header=BB51_2 Depth=1
	or	a, a
	sbc	hl, hl
	push	hl
	ld	hl, (ix - 43)
	...
	pop	hl
	.local	.LBB51_83
.LBB51_83:                              ;   in Loop: Header=BB51_2 Depth=1
	...
	ld	bc, (ix - 34)
	jr	nz, .LBB51_85
; %bb.84:                               ;   in Loop: Header=BB51_2 Depth=1
	ld	e, l
	ld	d, h
	.local	.LBB51_85
.LBB51_85:                              ;   in Loop: Header=BB51_2 Depth=1
	...
	jp	.LBB51_51
	.local	.LBB51_86
.LBB51_86:                              ;   in Loop: Header=BB51_2 Depth=1
	bit	0, (ix - 40)                    ; 1-byte Folded Reload
	ld	hl, 4
	jp	z, .LBB51_90
; %bb.87:                               ;   in Loop: Header=BB51_2 Depth=1
	...
	ld.sis	hl, 1
                                        ; kill: def $hl killed $hl def $uhl
	jp	z, .LBB51_89
; %bb.88:                               ;   in Loop: Header=BB51_2 Depth=1
	ld.sis	hl, 0
                                        ; kill: def $hl killed $hl def $uhl
	.local	.LBB51_89
.LBB51_89:                              ;   in Loop: Header=BB51_2 Depth=1
	...
	ld	bc, (ix - 37)
	.local	.LBB51_90
.LBB51_90:                              ;   in Loop: Header=BB51_2 Depth=1
	ld	(ix - 31), hl
	push	bc
	call	_ti_Close
	pop	hl
...
.LBB51_91:                              ;   in Loop: Header=BB51_2 Depth=1
	...
	jp	.LBB51_15
	.local	.LBB51_92
.LBB51_92:                              ;   in Loop: Header=BB51_2 Depth=1
	ld	hl, (ix - 49)
	push	hl
	call	_ti_Close
	pop	hl
...
.Lfunc_end52:
	.size	_handle_event, .Lfunc_end52-_handle_event
                                        ; -- End function
	.section	.text._endpoint,"ax",@progbits
	.type	_endpoint,@function             ; -- Begin function endpoint
_endpoint:                              ; @endpoint
; %bb.0:
	call	__frameset0
	ld	de, 0
...
.LBB53_2:
	...
	.local	.Lfunc_end53
.Lfunc_end53:
	.size	_endpoint, .Lfunc_end53-_endpoint
                                        ; -- End function
...
.LBB54_6:
	...
	.local	.Lfunc_end54
.Lfunc_end54:
	.size	_request_arrived, .Lfunc_end54-_request_arrived
                                        ; -- End function
...
.LBB58_10:                              ; %.loopexit
	...
	.local	.Lfunc_end58
.Lfunc_end58:
	.size	_write_exact, .Lfunc_end58-_write_exact
                                        ; -- End function
...
; %bb.0:
	...
	.local	.Lfunc_end59
.Lfunc_end59:
	.size	_reply, .Lfunc_end59-_reply
                                        ; -- End function
...
.LBB60_14:                              ; %.loopexit
	...
	.local	.Lfunc_end60
.Lfunc_end60:
	.size	_read_exact, .Lfunc_end60-_read_exact
                                        ; -- End function
...
.LBB61_20:                              ;   in Loop: Header=BB61_4 Depth=1
	...
	bit	0, a
	jr	z, .LBB61_22
; %bb.21:                               ;   in Loop: Header=BB61_4 Depth=1
	ld	de, -351
	lea	iy, ix + 0
	add	iy, de
	ld	hl, (iy + 0)
...
; %bb.27:                               ; %input_pressed.exit
	...
	bit	1, a
	jr	nz, .LBB61_29
; %bb.28:                               ;   in Loop: Header=BB61_4 Depth=1
	push	ix
	ld	de, -344
	add	ix, de
	ld	iy, (ix + 0)
	...
	jp	.LBB61_43
	.local	.LBB61_29
.LBB61_29:                              ; %input_pressed.exit.thread
                                        ;   in Loop: Header=BB61_4 Depth=1
	bit	2, h
	jr	z, .LBB61_33
; %bb.30:                               ; %input_pressed.exit4
	...
	bit	2, a
	jr	nz, .LBB61_33
; %bb.31:                               ;   in Loop: Header=BB61_4 Depth=1
	push	ix
	ld	de, -344
	add	ix, de
	ld	iy, (ix + 0)
	...
	ld	c, a
	jp	z, .LBB61_50
; %bb.32:                               ;   in Loop: Header=BB61_4 Depth=1
	ld	d, e
	jp	.LBB61_42
	.local	.LBB61_33
.LBB61_33:                              ; %input_pressed.exit4.thread
                                        ;   in Loop: Header=BB61_4 Depth=1
	ld	a, (_current+1)
	bit	6, a
	jp	z, .LBB61_50
; %bb.34:                               ; %input_pressed.exit5
	...
	bit	6, a
	jp	nz, .LBB61_50
; %bb.35:                               ;   in Loop: Header=BB61_4 Depth=1
	push	ix
	ld	de, -344
	add	ix, de
	ld	iy, (ix + 0)
	...
	or	a, a
	jr	z, .LBB61_41
; %bb.36:                               ;   in Loop: Header=BB61_4 Depth=1
	ld	d, 0
	jr	.LBB61_43
	.local	.LBB61_37
.LBB61_37:                              ;   in Loop: Header=BB61_4 Depth=1
	ld	hl, 1796
	push	hl
	call	_input_repeat
	pop	hl
	bit	0, a
	jr	z, .LBB61_39
; %bb.38:                               ;   in Loop: Header=BB61_4 Depth=1
	or	a, a
	sbc	hl, hl
	push	hl
	ld	de, -351
	...
	jp	.LBB61_25
	.local	.LBB61_39
.LBB61_39:                              ;   in Loop: Header=BB61_4 Depth=1
	ld	hl, 1794
	push	hl
	call	_input_repeat
	pop	hl
	...
	ld	c, a
	jp	z, .LBB61_26
; %bb.40:                               ;   in Loop: Header=BB61_4 Depth=1
	ld	de, -351
	lea	iy, ix + 0
	add	iy, de
	ld	hl, (iy + 0)
	...
	jp	.LBB61_25
	.local	.LBB61_41
.LBB61_41:                              ;   in Loop: Header=BB61_4 Depth=1
	push	ix
	ld	bc, -344
	add	ix, bc
	ld	iy, (ix + 0)
	...
	ld	d, (iy + 14)
	.local	.LBB61_42
.LBB61_42:                              ;   in Loop: Header=BB61_4 Depth=1
	dec	d
	.local	.LBB61_43
.LBB61_43:                              ;   in Loop: Header=BB61_4 Depth=1
	push	ix
	ld	bc, -344
	add	ix, bc
	ld	iy, (ix + 0)
	...
	ld	c, a
	jp	nc, .LBB61_50
; %bb.44:                               ;   in Loop: Header=BB61_4 Depth=1
	ld	a, e
	cp	a, d
	ld	a, 1
	ld	c, a
	jp	z, .LBB61_50
; %bb.45:                               ;   in Loop: Header=BB61_4 Depth=1
	ld	bc, -351
	lea	iy, ix + 0
	add	iy, bc
	...
	bit	0, a
	jr	nz, .LBB61_47
; %bb.46:                               ;   in Loop: Header=BB61_4 Depth=1
	or	a, a
	sbc	hl, hl
	.local	.LBB61_47
.LBB61_47:                              ;   in Loop: Header=BB61_4 Depth=1
	push	ix
	ld	de, -344
	add	ix, de
	ld	iy, (ix + 0)
	...
	lea	hl, iy + 0
	jr	nz, .LBB61_49
; %bb.48:                               ;   in Loop: Header=BB61_4 Depth=1
	or	a, a
	sbc	hl, hl
	.local	.LBB61_49
.LBB61_49:                              ;   in Loop: Header=BB61_4 Depth=1
	push	ix
	ld	de, -344
	add	ix, de
	ld	iy, (ix + 0)
...
.LBB61_54:                              ; %set_layer.exit
	...
	bit	0, e
	jp	nz, .LBB61_58
; %bb.55:                               ;   in Loop: Header=BB61_4 Depth=1
	lea	iy, ix + 0
	lea	iy, iy - 128
	lea	iy, iy - 128
	lea	iy, iy - 112
	...
	call	__lcmpu
	jr	c, .LBB61_57
; %bb.56:                               ;   in Loop: Header=BB61_4 Depth=1
	ld	a, 1
	ld	de, -345
	lea	iy, ix + 0
	add	iy, de
	ld	(iy + 0), a                     ; 1-byte Folded Spill
	.local	.LBB61_57
.LBB61_57:                              ;   in Loop: Header=BB61_4 Depth=1
	ld	de, -351
	lea	iy, ix + 0
	add	iy, de
	ld	h, (iy + 0)                     ; 1-byte Folded Reload
	...
	ld	d, (iy + 0)                     ; 1-byte Folded Reload
	.local	.LBB61_58
.LBB61_58:                              ;   in Loop: Header=BB61_4 Depth=1
	bit	0, c
	ld	l, 1
	ld	bc, 60
	jr	nz, .LBB61_64
; %bb.59:                               ;   in Loop: Header=BB61_4 Depth=1
	bit	0, d
	jr	nz, .LBB61_64
; %bb.60:                               ;   in Loop: Header=BB61_4 Depth=1
	ld	a, h
	ld	de, -354
	lea	iy, ix + 0
	add	iy, de
	...
	ld	bc, 0
	jr	z, .LBB61_64
; %bb.61:                               ;   in Loop: Header=BB61_4 Depth=1
	ld	bc, -354
	lea	iy, ix + 0
	add	iy, bc
	ld	de, (iy + 0)
	...
	ld	l, -1
	jr	z, .LBB61_63
; %bb.62:                               ;   in Loop: Header=BB61_4 Depth=1
	ld	l, 0
	.local	.LBB61_63
.LBB61_63:                              ;   in Loop: Header=BB61_4 Depth=1
	ld	h, a
	.local	.LBB61_64
.LBB61_64:                              ;   in Loop: Header=BB61_4 Depth=1
	bit	6, h
	jp	z, .LBB61_4
; %bb.65:                               ;   in Loop: Header=BB61_4 Depth=1
	ld	a, (_previous+6)
	bit	6, a
	jp	nz, .LBB61_4
; %bb.66:
...
.LBB61_73:
	...
	.local	.Lfunc_end61
.Lfunc_end61:
	.size	_viewer_run, .Lfunc_end61-_viewer_run
                                        ; -- End function
...
.LBB62_8:
	...
	.local	.Lfunc_end62
.Lfunc_end62:
	.size	_clamp, .Lfunc_end62-_clamp
                                        ; -- End function
...
_.str.44:
	...
	.section	.rodata._.str.1.45,"a",@progbits
	.balign	1
	.local	_.str.1.45
_.str.1.45:
...
_stream:
	...
	.section	.rodata._.str.2.40,"a",@progbits
	.balign	1
	.local	_.str.2.40
_.str.2.40:
	.asciz	"w"

	.section	.rodata._.str.3.41,"a",@progbits
	.balign	1
	.local	_.str.3.41
_.str.3.41:
	.asciz	"Receiving"

	.section	.rodata._.str.4.42,"a",@progbits
	.balign	1
	.local	_.str.4.42
_.str.4.42:
	.asciz	"CSLIB"

	.section	.rodata._.str.5.43,"a",@progbits
	.balign	1
	.local	_.str.5.43
_.str.5.43:
	.asciz	"r"
...
_.str.48:
	...
	.section	.rodata._.str.1.49,"a",@progbits
	.balign	1
	.local	_.str.1.49
_.str.1.49:
	.asciz	"Re-sync it from the computer."

	.section	.rodata._.str.2.52,"a",@progbits
	.balign	1
	.local	_.str.2.52
_.str.2.52:
	.asciz	"%u.%ux %u%%%s"

	.section	.rodata._.str.3.50,"a",@progbits
	.balign	1
	.local	_.str.3.50
_.str.3.50:
	.asciz	" read"

	.section	.rodata._.str.4.51,"a",@progbits
	.balign	1
	.local	_.str.4.51
_.str.4.51:
	.zero	1
