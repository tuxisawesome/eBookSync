...
; %bb.0:
	...
	.local	.Lfunc_end44
.Lfunc_end44:
	.size	_proto_requests, .Lfunc_end44-_proto_requests
                                        ; -- End function
...
; %bb.0:
	...
	.local	.Lfunc_end45
.Lfunc_end45:
	.size	_proto_last_command, .Lfunc_end45-_proto_last_command
                                        ; -- End function
...
; %bb.0:
	...
	.local	.Lfunc_end46
.Lfunc_end46:
	.size	_proto_errors, .Lfunc_end46-_proto_errors
                                        ; -- End function
...
; %bb.0:
	...
	.local	.Lfunc_end47
.Lfunc_end47:
	.size	_proto_schedule_error, .Lfunc_end47-_proto_schedule_error
                                        ; -- End function
...
; %bb.0:
	...
	.local	.Lfunc_end48
.Lfunc_end48:
	.size	_proto_loops, .Lfunc_end48-_proto_loops
                                        ; -- End function
...
; %bb.0:
	...
	.local	.Lfunc_end49
.Lfunc_end49:
	.size	_proto_mark, .Lfunc_end49-_proto_mark
                                        ; -- End function
...
; %bb.14:                               ;   in Loop: Header=BB50_2 Depth=1
	...
	ld	hl, (ix - 31)
	.local	.LBB50_15
.LBB50_15:                              ;   in Loop: Header=BB50_2 Depth=1
	push	hl
	call	_reply
	.local	.LBB50_16
.LBB50_16:                              ;   in Loop: Header=BB50_2 Depth=1
	pop	hl
	.local	.LBB50_17
.LBB50_17:                              ;   in Loop: Header=BB50_2 Depth=1
	pop	hl
	pop	hl
	bit	0, a
	jr	nz, .LBB50_19
...
.LBB50_19:                              ; %.loopexit11
	...
	sbc	hl, bc
	jp	z, .LBB50_2
; %bb.20:                               ;   in Loop: Header=BB50_2 Depth=1
	ld	a, (_configured)
	bit	0, a
	ld	hl, _.str.44
	jr	nz, .LBB50_22
...
.LBB50_22:                              ;   in Loop: Header=BB50_2 Depth=1
	...
	jp	.LBB50_95
	.local	.LBB50_23
.LBB50_23:                              ;   in Loop: Header=BB50_2 Depth=1
	ld	(ix - 31), hl
	ld	de, 0
	ld	e, a
	ld	hl, JTI50_0
...
; %bb.25:                               ;   in Loop: Header=BB50_2 Depth=1
	...
	ld	b, h
	.local	.LBB50_26
.LBB50_26:                              ;   Parent Loop BB50_2 Depth=1
                                        ; =>  This Inner Loop Header: Depth=2
	ld	l, e
	ld	h, d
	or	a, a
...
; %bb.27:                               ;   in Loop: Header=BB50_26 Depth=2
	...
	ld	(ix - 34), bc
	jr	nc, .LBB50_29
; %bb.28:                               ;   in Loop: Header=BB50_26 Depth=2
	push	iy
	ld	hl, _stream
	push	hl
	call	_write_exact
	...
	jr	.LBB50_30
	.local	.LBB50_29
.LBB50_29:                              ;   in Loop: Header=BB50_26 Depth=2
	lea	de, iy + 0
	ld	hl, (ix - 31)
	.local	.LBB50_30
.LBB50_30:                              ;   in Loop: Header=BB50_26 Depth=2
	ld	(ix - 37), de
	pea	ix - 17
	push	bc
	call	_lib_get_strip
...
; %bb.32:                               ;   in Loop: Header=BB50_2 Depth=1
	...
	jp	.LBB50_16
	.local	.LBB50_33
.LBB50_33:                              ;   in Loop: Header=BB50_2 Depth=1
	ld	iy, (ix - 31)
	lea	hl, iy + 0
	ld	(ix - 46), bc
	ld	e, c
	...
	call	__lcmpu
	jp	nc, .LBB50_48
; %bb.34:                               ;   in Loop: Header=BB50_2 Depth=1
	ld	hl, (ix - 46)
	push	hl
	push	iy
	call	_drain
	...
	jp	.LBB50_50
	.local	.LBB50_35
.LBB50_35:                              ;   in Loop: Header=BB50_2 Depth=1
	push	bc
	ld	hl, (ix - 31)
	push	hl
	call	_drain
	...
	ld.sis	hl, 5
                                        ; kill: def $hl killed $hl def $uhl
	jp	z, .LBB50_37
; %bb.36:                               ;   in Loop: Header=BB50_2 Depth=1
	ld.sis	hl, 0
                                        ; kill: def $hl killed $hl def $uhl
	.local	.LBB50_37
.LBB50_37:                              ;   in Loop: Header=BB50_2 Depth=1
	ld	de, 0
	push	de
	inc	de
	push	de
	...
	bit	0, a
	jp	z, .LBB50_18
; %bb.38:                               ;   in Loop: Header=BB50_2 Depth=1
	ld	hl, 1
	push	hl
	pea	ix - 17
	jp	.LBB50_56
	.local	.LBB50_39
.LBB50_39:                              ;   in Loop: Header=BB50_2 Depth=1
	ld	hl, 65535
	ld	e, 0
	push	bc
	pop	iy
	...
	call	__lcmpu
	jp	nc, .LBB50_52
; %bb.40:                               ;   in Loop: Header=BB50_2 Depth=1
	push	iy
	push	bc
	call	_drain
	pop	hl
	...
	jp	.LBB50_91
	.local	.LBB50_41
.LBB50_41:                              ;   in Loop: Header=BB50_2 Depth=1
	push	bc
	ld	hl, (ix - 31)
	push	hl
	call	_drain
	...
	jp	.LBB50_15
	.local	.LBB50_42
.LBB50_42:                              ;   in Loop: Header=BB50_2 Depth=1
	push	de
	ld	(ix - 37), de
	call	_ti_GetSize
	ld	(ix - 31), l
	...
	pop	hl
	.local	.LBB50_43
.LBB50_43:                              ;   Parent Loop BB50_2 Depth=1
                                        ; =>  This Inner Loop Header: Depth=2
	bit	0, a
	jp	z, .LBB50_18
; %bb.44:                               ; %.preheader10
...
; %bb.45:                               ;   in Loop: Header=BB50_43 Depth=2
	...
	ld	(ix - 30), b
	jr	c, .LBB50_47
; %bb.46:                               ;   in Loop: Header=BB50_43 Depth=2
	ld.sis	bc, 512
	.local	.LBB50_47
.LBB50_47:                              ;   in Loop: Header=BB50_43 Depth=2
	...
	jr	.LBB50_43
	.local	.LBB50_48
.LBB50_48:                              ;   in Loop: Header=BB50_2 Depth=1
	ld	hl, (ix - 43)
	push	hl
	ld	hl, (ix - 37)
	push	hl
	...
	or	a, a
	jr	nz, .LBB50_57
; %bb.49:                               ;   in Loop: Header=BB50_2 Depth=1
	ld	hl, (ix - 46)
	push	hl
	ld	hl, (ix - 31)
	push	hl
	...
	ld	hl, 4
	.local	.LBB50_50
.LBB50_50:                              ;   in Loop: Header=BB50_2 Depth=1
	push	hl
	ld	hl, (ix - 34)
	push	hl
	.local	.LBB50_51
.LBB50_51:                              ;   in Loop: Header=BB50_2 Depth=1
	ld	hl, 3
	jp	.LBB50_15
	.local	.LBB50_52
.LBB50_52:                              ;   in Loop: Header=BB50_2 Depth=1
	ld	(ix - 46), iy
	ld	hl, _.str.4.42
	push	hl
	call	_ti_Delete
	...
	or	a, a
	jp	nz, .LBB50_67
; %bb.53:                               ;   in Loop: Header=BB50_2 Depth=1
	ld	hl, (ix - 46)
	push	hl
	ld	hl, (ix - 31)
	push	hl
	...
	jp	.LBB50_91
	.local	.LBB50_54
.LBB50_54:                              ;   in Loop: Header=BB50_2 Depth=1
	lea	de, iy + 0
	sbc	hl, hl
	adc	hl, de
	jp	z, .LBB50_19
; %bb.55:                               ;   in Loop: Header=BB50_2 Depth=1
	push	de
	ld	hl, _stream
	push	hl
	.local	.LBB50_56
.LBB50_56:                              ;   in Loop: Header=BB50_2 Depth=1
	call	_write_exact
	jp	.LBB50_17
	.local	.LBB50_57
.LBB50_57:                              ;   in Loop: Header=BB50_2 Depth=1
	ld	a, 1
...
.LBB50_61:                              ;   in Loop: Header=BB50_58 Depth=2
	...
	ld	a, l
	jr	nz, .LBB50_63
; %bb.62:                               ;   in Loop: Header=BB50_58 Depth=2
	xor	a, a
	.local	.LBB50_63
.LBB50_63:                              ;   in Loop: Header=BB50_58 Depth=2
	ld	(ix - 53), a
	push	de
	ld	(ix - 52), de
	call	_read_exact
	...
	bit	0, a
	jp	z, .LBB50_92
; %bb.64:                               ;   in Loop: Header=BB50_58 Depth=2
	ld	hl, (ix - 49)
	push	hl
	ld	hl, 1
	push	hl
	...
	ld	a, -1
	jr	z, .LBB50_66
; %bb.65:                               ;   in Loop: Header=BB50_58 Depth=2
	ld	a, 0
	.local	.LBB50_66
.LBB50_66:                              ;   in Loop: Header=BB50_58 Depth=2
	ld	l, (ix - 40)
	and	a, l
	ld	l, a
	ld	(ix - 40), l
	...
	jp	.LBB50_58
	.local	.LBB50_67
.LBB50_67:                              ;   in Loop: Header=BB50_2 Depth=1
	ld	a, 1
	ld	(ix - 40), a                    ; 1-byte Folded Spill
	ld	iy, (ix - 31)
	ld	de, (ix - 46)
...
; %bb.69:                               ;   in Loop: Header=BB50_68 Depth=2
	...
	lea	de, iy + 0
	jr	nz, .LBB50_71
; %bb.70:                               ;   in Loop: Header=BB50_68 Depth=2
	ld	hl, 512
	ex	de, hl
	.local	.LBB50_71
.LBB50_71:                              ;   in Loop: Header=BB50_68 Depth=2
	ld	(ix - 31), iy
	bit	0, a
	ld	hl, (ix - 46)
	ld	a, l
	jr	nz, .LBB50_73
; %bb.72:                               ;   in Loop: Header=BB50_68 Depth=2
	xor	a, a
	.local	.LBB50_73
.LBB50_73:                              ;   in Loop: Header=BB50_68 Depth=2
	...
	bit	0, a
	jp	z, .LBB50_93
; %bb.74:                               ;   in Loop: Header=BB50_68 Depth=2
	ld	hl, (ix - 37)
	push	hl
	ld	hl, 1
	push	hl
	...
	ld	a, -1
	jr	z, .LBB50_76
; %bb.75:                               ;   in Loop: Header=BB50_68 Depth=2
	ld	a, 0
	.local	.LBB50_76
.LBB50_76:                              ;   in Loop: Header=BB50_68 Depth=2
	...
	jp	.LBB50_68
	.local	.LBB50_77
.LBB50_77:                              ;   in Loop: Header=BB50_2 Depth=1
	bit	0, (ix - 40)                    ; 1-byte Folded Reload
	ld	a, 0
	jr	z, .LBB50_81
; %bb.78:                               ;   in Loop: Header=BB50_2 Depth=1
	push	bc
	ld	hl, 1
	push	hl
	call	_ti_SetArchiveStatus
	...
	ld	a, -1
	jr	nz, .LBB50_80
; %bb.79:                               ;   in Loop: Header=BB50_2 Depth=1
	ld	a, 0
	.local	.LBB50_80
.LBB50_80:                              ;   in Loop: Header=BB50_2 Depth=1
	ld	bc, (ix - 49)
	.local	.LBB50_81
.LBB50_81:                              ;   in Loop: Header=BB50_2 Depth=1
	ld	(ix - 31), a
	push	bc
	call	_ti_Close
	pop	hl
	...
	sbc	hl, bc
	jr	z, .LBB50_83
; %bb.82:                               ;   in Loop: Header=BB50_2 Depth=1
	or	a, a
	sbc	hl, hl
	push	hl
	ld	hl, (ix - 43)
	...
	pop	hl
	.local	.LBB50_83
.LBB50_83:                              ;   in Loop: Header=BB50_2 Depth=1
	...
	ld	bc, (ix - 34)
	jr	nz, .LBB50_85
; %bb.84:                               ;   in Loop: Header=BB50_2 Depth=1
	ld	e, l
	ld	d, h
	.local	.LBB50_85
.LBB50_85:                              ;   in Loop: Header=BB50_2 Depth=1
	push	de
	push	bc
	jp	.LBB50_51
	.local	.LBB50_86
.LBB50_86:                              ;   in Loop: Header=BB50_2 Depth=1
	bit	0, (ix - 40)                    ; 1-byte Folded Reload
	ld	hl, 4
	jp	z, .LBB50_90
; %bb.87:                               ;   in Loop: Header=BB50_2 Depth=1
	push	bc
	ld	hl, 1
	push	hl
	call	_ti_SetArchiveStatus
	...
	ld.sis	hl, 1
                                        ; kill: def $hl killed $hl def $uhl
	jp	z, .LBB50_89
; %bb.88:                               ;   in Loop: Header=BB50_2 Depth=1
	ld.sis	hl, 0
                                        ; kill: def $hl killed $hl def $uhl
	.local	.LBB50_89
.LBB50_89:                              ;   in Loop: Header=BB50_2 Depth=1
	add	hl, hl
	add	hl, hl
                                        ; kill: def $hl killed $hl def $uhl
	ld	bc, (ix - 37)
	.local	.LBB50_90
.LBB50_90:                              ;   in Loop: Header=BB50_2 Depth=1
	ld	(ix - 31), hl
	push	bc
	call	_ti_Close
	pop	hl
	...
	ld	hl, (ix - 31)
	.local	.LBB50_91
.LBB50_91:                              ;   in Loop: Header=BB50_2 Depth=1
	push	hl
	ld	hl, (ix - 34)
	push	hl
	ld	hl, 6
	jp	.LBB50_15
	.local	.LBB50_92
.LBB50_92:                              ;   in Loop: Header=BB50_2 Depth=1
	ld	hl, (ix - 49)
	push	hl
	call	_ti_Close
	pop	hl
	...
	jr	.LBB50_94
	.local	.LBB50_93
.LBB50_93:                              ;   in Loop: Header=BB50_2 Depth=1
	ld	hl, (ix - 37)
	push	hl
	call	_ti_Close
	pop	hl
...
.LBB50_98:
	...
	.local	.Lfunc_end50
.Lfunc_end50:
	.size	_proto_run, .Lfunc_end50-_proto_run
...
.LBB51_11:
	...
	.local	.Lfunc_end51
.Lfunc_end51:
	.size	_handle_event, .Lfunc_end51-_handle_event
                                        ; -- End function
...
.LBB52_2:
	...
	.local	.Lfunc_end52
.Lfunc_end52:
	.size	_endpoint, .Lfunc_end52-_endpoint
                                        ; -- End function
...
.LBB53_6:
	...
	.local	.Lfunc_end53
.Lfunc_end53:
	.size	_request_arrived, .Lfunc_end53-_request_arrived
                                        ; -- End function
...
.LBB57_10:                              ; %.loopexit
	...
	.local	.Lfunc_end57
.Lfunc_end57:
	.size	_write_exact, .Lfunc_end57-_write_exact
                                        ; -- End function
...
_.str.13:
	...
	.local	_.str.14
_.str.14:
	.asciz	"requests %u  last cmd %u  errors %u"

	.section	.rodata._.str.15,"a",@progbits
	.balign	1
	.local	_.str.15
_.str.15:
	.asciz	"schedule %u  loops %u"

	.section	.rodata._.str.16,"a",@progbits
	.balign	1
	.local	_.str.16
_.str.16:
	.asciz	"corner: red=usb yel=sched grn=keys blu=draw"
