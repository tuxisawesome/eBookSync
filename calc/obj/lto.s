...
; %bb.23:                               ;   in Loop: Header=BB51_2 Depth=1
	...
	ld	hl, _.str.44
	jr	nz, .LBB51_25
; %bb.24:                               ;   in Loop: Header=BB51_2 Depth=1
	ld	hl, _.str.1.45
	.local	.LBB51_25
.LBB51_25:                              ;   in Loop: Header=BB51_2 Depth=1
	push	de
	push	de
	push	de
	push	hl
...
.LBB51_26:                              ;   in Loop: Header=BB51_2 Depth=1
	...
	jp	(hl)
	.local	.LBB51_27
.LBB51_27:                              ;   in Loop: Header=BB51_2 Depth=1
	push	bc
	push	iy
	call	_drain
	pop	hl
...
; %bb.28:                               ;   in Loop: Header=BB51_2 Depth=1
	...
	ld	b, h
	.local	.LBB51_29
.LBB51_29:                              ;   Parent Loop BB51_2 Depth=1
                                        ; =>  This Inner Loop Header: Depth=2
	ld	l, e
	ld	h, d
	or	a, a
...
.LBB51_32:                              ;   in Loop: Header=BB51_29 Depth=2
	...
	ld	hl, (ix - 31)
	.local	.LBB51_33
.LBB51_33:                              ;   in Loop: Header=BB51_29 Depth=2
	ld	(ix - 37), de
	pea	ix - 17
	push	bc
	call	_lib_get_strip
	...
	jp	.LBB51_29
	.local	.LBB51_34
.LBB51_34:                              ;   in Loop: Header=BB51_2 Depth=1
	push	bc
	push	iy
	call	_drain
	pop	hl
	...
	or	a, a
	jp	nz, .LBB51_45
; %bb.35:                               ;   in Loop: Header=BB51_2 Depth=1
	or	a, a
	sbc	hl, hl
	ex	de, hl
	push	de
	...
	jp	.LBB51_19
	.local	.LBB51_36
.LBB51_36:                              ;   in Loop: Header=BB51_2 Depth=1
	lea	hl, iy + 0
	ld	e, c
	ld	(ix - 31), bc
	ld	bc, -16385
	...
	call	__lcmpu
	jp	nc, .LBB51_51
; %bb.37:                               ;   in Loop: Header=BB51_2 Depth=1
	ld	hl, (ix - 31)
	push	hl
	push	iy
	call	_drain
	...
	jp	.LBB51_53
	.local	.LBB51_38
.LBB51_38:                              ;   in Loop: Header=BB51_2 Depth=1
	push	bc
	push	iy
	call	_drain
	pop	hl
	...
	ld.sis	hl, 5
                                        ; kill: def $hl killed $hl def $uhl
	jp	z, .LBB51_40
; %bb.39:                               ;   in Loop: Header=BB51_2 Depth=1
	ld.sis	hl, 0
                                        ; kill: def $hl killed $hl def $uhl
	.local	.LBB51_40
.LBB51_40:                              ;   in Loop: Header=BB51_2 Depth=1
	ld	de, 0
	push	de
	inc	de
	push	de
	...
	bit	0, a
	jp	z, .LBB51_21
; %bb.41:                               ;   in Loop: Header=BB51_2 Depth=1
	ld	hl, 1
	push	hl
	pea	ix - 17
	jp	.LBB51_59
...
.LBB51_42:                              ;   in Loop: Header=BB51_2 Depth=1
	...
	call	__lcmpu
	jp	nc, .LBB51_55
; %bb.43:                               ;   in Loop: Header=BB51_2 Depth=1
	ld	hl, (ix - 31)
	push	hl
	ld	hl, (ix - 40)
	push	hl
	...
	jp	.LBB51_94
	.local	.LBB51_44
.LBB51_44:                              ;   in Loop: Header=BB51_2 Depth=1
	push	bc
	push	iy
	call	_drain
	pop	hl
...
.LBB51_45:                              ;   in Loop: Header=BB51_2 Depth=1
	...
	pop	hl
	.local	.LBB51_46
.LBB51_46:                              ;   Parent Loop BB51_2 Depth=1
                                        ; =>  This Inner Loop Header: Depth=2
	bit	0, a
	jp	z, .LBB51_21
; %bb.47:                               ; %.preheader12
	...
	adc.sis	hl, bc
	jp	z, .LBB51_22
; %bb.48:                               ;   in Loop: Header=BB51_46 Depth=2
	ld	l, c
	ld	h, b
	ld.sis	de, 512
	or	a, a
	...
	ld	(ix - 30), b
	jr	c, .LBB51_50
; %bb.49:                               ;   in Loop: Header=BB51_46 Depth=2
	ld.sis	bc, 512
	.local	.LBB51_50
.LBB51_50:                              ;   in Loop: Header=BB51_46 Depth=2
	ld	(ix - 37), c
	ld	(ix - 36), b
	or	a, a
	sbc	hl, hl
...
.LBB51_51:                              ;   in Loop: Header=BB51_2 Depth=1
	...
	or	a, a
	jr	nz, .LBB51_60
; %bb.52:                               ;   in Loop: Header=BB51_2 Depth=1
	ld	hl, (ix - 31)
	push	hl
	ld	hl, (ix - 40)
	push	hl
	...
	ld	hl, 4
	.local	.LBB51_53
.LBB51_53:                              ;   in Loop: Header=BB51_2 Depth=1
	push	hl
	ld	hl, (ix - 34)
	push	hl
	.local	.LBB51_54
.LBB51_54:                              ;   in Loop: Header=BB51_2 Depth=1
	...
	jp	.LBB51_18
	.local	.LBB51_55
.LBB51_55:                              ;   in Loop: Header=BB51_2 Depth=1
	ld	hl, _.str.5.42
	push	hl
	call	_ti_Delete
	pop	hl
	...
	or	a, a
	jp	nz, .LBB51_70
; %bb.56:                               ;   in Loop: Header=BB51_2 Depth=1
	ld	hl, (ix - 31)
	push	hl
	ld	hl, (ix - 40)
	push	hl
...
; %bb.62:                               ;   in Loop: Header=BB51_61 Depth=2
	...
	lea	de, iy + 0
	jr	nz, .LBB51_64
; %bb.63:                               ;   in Loop: Header=BB51_61 Depth=2
	ld	hl, 512
	ex	de, hl
	.local	.LBB51_64
.LBB51_64:                              ;   in Loop: Header=BB51_61 Depth=2
	ld	(ix - 40), iy
	bit	0, a
	ld	hl, (ix - 31)
	ld	a, l
	jr	nz, .LBB51_66
; %bb.65:                               ;   in Loop: Header=BB51_61 Depth=2
	xor	a, a
	.local	.LBB51_66
.LBB51_66:                              ;   in Loop: Header=BB51_61 Depth=2
	ld	(ix - 53), a
	push	de
	ld	(ix - 52), de
	call	_read_exact
	...
	bit	0, a
	jp	z, .LBB51_95
; %bb.67:                               ;   in Loop: Header=BB51_61 Depth=2
	ld	hl, (ix - 49)
	push	hl
	ld	hl, 1
	push	hl
	...
	ld	a, -1
	jr	z, .LBB51_69
; %bb.68:                               ;   in Loop: Header=BB51_61 Depth=2
	ld	a, 0
	.local	.LBB51_69
.LBB51_69:                              ;   in Loop: Header=BB51_61 Depth=2
	ld	l, (ix - 46)
	and	a, l
	ld	l, a
	ld	(ix - 46), l
	...
	jp	.LBB51_61
	.local	.LBB51_70
.LBB51_70:                              ;   in Loop: Header=BB51_2 Depth=1
	ld	a, 1
	...
	ld	(ix - 37), bc
	.local	.LBB51_71
.LBB51_71:                              ; %.preheader15
                                        ;   Parent Loop BB51_2 Depth=1
                                        ; =>  This Inner Loop Header: Depth=2
	lea	hl, iy + 0
	call	__lcmpzero
	jp	z, .LBB51_89
; %bb.72:                               ;   in Loop: Header=BB51_71 Depth=2
	lea	hl, iy + 0
	ld	(ix - 31), de
                                        ; kill: def $e killed $e killed $ude
	ld	bc, 512
	...
	lea	de, iy + 0
	jr	nz, .LBB51_74
; %bb.73:                               ;   in Loop: Header=BB51_71 Depth=2
	ld	hl, 512
	ex	de, hl
	.local	.LBB51_74
.LBB51_74:                              ;   in Loop: Header=BB51_71 Depth=2
	ld	(ix - 40), iy
	bit	0, a
	ld	hl, (ix - 31)
	ld	a, l
	jr	nz, .LBB51_76
; %bb.75:                               ;   in Loop: Header=BB51_71 Depth=2
	xor	a, a
	.local	.LBB51_76
.LBB51_76:                              ;   in Loop: Header=BB51_71 Depth=2
	ld	(ix - 49), a
	push	de
	ld	(ix - 46), de
	call	_read_exact
	...
	bit	0, a
	jp	z, .LBB51_96
; %bb.77:                               ;   in Loop: Header=BB51_71 Depth=2
	ld	hl, (ix - 37)
	push	hl
	ld	hl, 1
	push	hl
	...
	ld	a, -1
	jr	z, .LBB51_79
; %bb.78:                               ;   in Loop: Header=BB51_71 Depth=2
	ld	a, 0
	.local	.LBB51_79
.LBB51_79:                              ;   in Loop: Header=BB51_71 Depth=2
	ld	l, (ix - 43)
	and	a, l
	ld	l, a
	ld	(ix - 43), l
...
.LBB51_80:                              ;   in Loop: Header=BB51_2 Depth=1
	...
	ld	a, 0
	jr	z, .LBB51_84
; %bb.81:                               ;   in Loop: Header=BB51_2 Depth=1
	push	bc
	ld	hl, 1
	push	hl
	call	_ti_SetArchiveStatus
...
.LBB51_83:                              ;   in Loop: Header=BB51_2 Depth=1
	ld	bc, (ix - 49)
	.local	.LBB51_84
.LBB51_84:                              ;   in Loop: Header=BB51_2 Depth=1
	ld	(ix - 31), a
	push	bc
	call	_ti_Close
	pop	hl
	...
	sbc	hl, bc
	jr	z, .LBB51_86
; %bb.85:                               ;   in Loop: Header=BB51_2 Depth=1
	or	a, a
	sbc	hl, hl
	push	hl
	ld	hl, (ix - 43)
...
; %bb.90:                               ;   in Loop: Header=BB51_2 Depth=1
	...
	ld.sis	hl, 1
                                        ; kill: def $hl killed $hl def $uhl
	jp	z, .LBB51_92
; %bb.91:                               ;   in Loop: Header=BB51_2 Depth=1
	ld.sis	hl, 0
                                        ; kill: def $hl killed $hl def $uhl
	.local	.LBB51_92
...
.LBB51_94:                              ;   in Loop: Header=BB51_2 Depth=1
	...
	jp	.LBB51_18
	.local	.LBB51_95
.LBB51_95:                              ;   in Loop: Header=BB51_2 Depth=1
	ld	hl, (ix - 49)
	push	hl
	call	_ti_Close
	pop	hl
	...
	jr	.LBB51_97
	.local	.LBB51_96
.LBB51_96:                              ;   in Loop: Header=BB51_2 Depth=1
	ld	hl, (ix - 37)
	push	hl
	call	_ti_Close
	pop	hl
...
_.str.2.46:
	...
	.section	.rodata._.str.3.40,"a",@progbits
	.balign	1
	.local	_.str.3.40
_.str.3.40:
	.asciz	"w"

	.section	.rodata._.str.4.41,"a",@progbits
	.balign	1
	.local	_.str.4.41
_.str.4.41:
	.asciz	"Receiving"
